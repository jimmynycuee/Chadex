...
const ALL_RUNNER_FEATURES: &[RunnerFeature] = &[
    ...
    RunnerFeature::StructuredSearchText,
...
impl RunnerFeature {
    ...
    pub const fn as_wire_name(self) -> &'static str {
        match self {
            ...
            Self::StructuredSearchText => wire::RUNNER_CAPABILITY_STRUCTURED_SEARCH_TEXT,
    ...
    pub(crate) fn from_wire_name(name: &str) -> Option<Self> {
        Some(match name {
            ...
            wire::RUNNER_CAPABILITY_STRUCTURED_SEARCH_TEXT => Self::StructuredSearchText,
    ...
    fn advertised_by(self, capabilities: &RunnerCapabilities) -> bool {
        match self {
            ...
            Self::StructuredSearchText => capabilities.structured_search_text,
