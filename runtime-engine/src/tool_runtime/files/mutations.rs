...
impl ToolRuntime {
    ...
    pub(crate) async fn write_project_file(
        ...
        self.write_project_file_with_resolution(
            project,
            path,
            content,
            overwrite,
    ...
    pub(crate) async fn write_project_file_resolved(
        &self,
        resolved: &ResolvedProject,
        path: String,
        content: String,
    ...
    async fn write_project_file_with_resolution(
        &self,
        project: String,
        path: String,
        content: String,
        overwrite: Option<bool>,
        expected_read_revision: Option<u64>,
        resolved_override: Option<ResolvedProject>,
    ) -> ToolResult {
        ...
        let resolved = match resolved_override {
            ...
            None => match self.resolve_project_input(&project).await {
    ...
    pub(crate) async fn apply_text_edits(
        ...
        self.apply_text_edits_with_resolution(project, changes, dry_run, None)
            .await
    }

    pub(crate) async fn apply_text_edits_resolved(
        &self,
        resolved: &ResolvedProject,
        changes: Vec<ApplyFileChangeInput>,
        dry_run: Option<bool>,
    ) -> ToolResult {
        self.apply_text_edits_with_resolution(
            resolved.resolved_id.clone(),
            changes,
            dry_run,
            Some(resolved.clone()),
    ...
    async fn apply_text_edits_with_resolution(
        &self,
        project: String,
        changes: Vec<ApplyFileChangeInput>,
        dry_run: Option<bool>,
