...
pub(super) const DEFINITIONS: &[ToolDefinition] = &[
    ...
    adaptive_runtime_direct(
        context_reobservable(model_spec(
            ...
            "Read runtime status for diagnostics, not before each project call. Reuse exact project IDs. Pass exact client_id for one Runner deployment/source alignment; omit for fleet-wide. Reports shared Job concurrency and bounded host_context advisory metadata, never authority.",
